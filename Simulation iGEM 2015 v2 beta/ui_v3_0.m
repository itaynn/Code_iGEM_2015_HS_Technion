function varargout = ui_v3_0(varargin)
% UI_V3_0 MATLAB code for ui_v3_0.fig
%      UI_V3_0, by itself, creates a new UI_V3_0 or raises the existing
%      singleton*.
%
%      H = UI_V3_0 returns the handle to a new UI_V3_0 or the handle to
%      the existing singleton*.
%
%      UI_V3_0('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UI_V3_0.M with the given input arguments.
%
%      UI_V3_0('Property','Value',...) creates a new UI_V3_0 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ui_v3_0_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ui_v3_0_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ui_v3_0

% Last Modified by GUIDE v2.5 12-May-2015 16:34:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @ui_v3_0_OpeningFcn, ...
    'gui_OutputFcn',  @ui_v3_0_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before ui_v3_0 is made visible.
function ui_v3_0_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ui_v3_0 (see VARARGIN)

% Choose default command line output for ui_v3_0
...
% so window can get raised using ui_v3_0.
...
% UIWAIT makes ui_v3_0 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ui_v3_0_OutputFcn(hObject, eventdata, handles)
