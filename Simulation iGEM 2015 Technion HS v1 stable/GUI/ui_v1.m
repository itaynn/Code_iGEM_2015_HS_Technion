function varargout = ui_v1(varargin)
% UI_V1 MATLAB code for ui_v1.fig
%      UI_V1, by itself, creates a new UI_V1 or raises the existing
%      singleton*.
%
%      H = UI_V1 returns the handle to a new UI_V1 or the handle to
%      the existing singleton*.
%
%      UI_V1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UI_V1.M with the given input arguments.
%
%      UI_V1('Property','Value',...) creates a new UI_V1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ui_v1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ui_v1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ui_v1

% Last Modified by GUIDE v2.5 21-Mar-2015 17:24:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ui_v1_OpeningFcn, ...
                   'gui_OutputFcn',  @ui_v1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ui_v1 is made visible.
function ui_v1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ui_v1 (see VARARGIN)

% Choose default command line output for ui_v1
...
% so window can get raised using ui_v1.
...
% UIWAIT makes ui_v1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ui_v1_OutputFcn(hObject, eventdata, handles)
