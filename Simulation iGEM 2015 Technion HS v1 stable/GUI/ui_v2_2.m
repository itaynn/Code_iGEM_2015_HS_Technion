function varargout = ui_v2_2(varargin)
% UI_V2_2 MATLAB code for ui_v2_2.fig
%      UI_V2_2, by itself, creates a new UI_V2_2 or raises the existing
%      singleton*.
%
%      H = UI_V2_2 returns the handle to a new UI_V2_2 or the handle to
%      the existing singleton*.
%
%      UI_V2_2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UI_V2_2.M with the given input arguments.
%
%      UI_V2_2('Property','Value',...) creates a new UI_V2_2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ui_v2_2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ui_v2_2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ui_v2_2

% Last Modified by GUIDE v2.5 26-Mar-2015 21:06:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @ui_v2_2_OpeningFcn, ...
    'gui_OutputFcn',  @ui_v2_2_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before ui_v2_2 is made visible.
function ui_v2_2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ui_v2_2 (see VARARGIN)

% Choose default command line output for ui_v2_2
...
% so window can get raised using ui_v2_2.
...
% UIWAIT makes ui_v2_2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ui_v2_2_OutputFcn(hObject, eventdata, handles)
