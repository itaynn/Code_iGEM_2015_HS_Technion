function varargout = ui1_working(varargin)
% UI1_WORKING MATLAB code for ui1_working.fig
%      UI1_WORKING, by itself, creates a new UI1_WORKING or raises the existing
%      singleton*.
%
%      H = UI1_WORKING returns the handle to a new UI1_WORKING or the handle to
%      the existing singleton*.
%
%      UI1_WORKING('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UI1_WORKING.M with the given input arguments.
%
%      UI1_WORKING('Property','Value',...) creates a new UI1_WORKING or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ui1_working_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ui1_working_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ui1_working

% Last Modified by GUIDE v2.5 21-Mar-2015 17:20:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ui1_working_OpeningFcn, ...
                   'gui_OutputFcn',  @ui1_working_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ui1_working is made visible.
function ui1_working_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ui1_working (see VARARGIN)

% Choose default command line output for ui1_working
...
% so window can get raised using ui1_working.
...
% UIWAIT makes ui1_working wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ui1_working_OutputFcn(hObject, eventdata, handles)
...
axes(handles.axes1);
cla;
[total_time,C,V,U,A,B,N_max ,A_0,N_0,tot_a,tot_b, option]= getVarsGUI( hObject,handles );
doSimulation( total_time,C,V,U,A,B,N_max ,A_0,N_0,tot_a,tot_b, option);
