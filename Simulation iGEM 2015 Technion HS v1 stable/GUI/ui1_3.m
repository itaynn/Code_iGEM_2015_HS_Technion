function varargout = ui1_3(varargin)
% UI1_3 MATLAB code for ui1_3.fig
%      UI1_3, by itself, creates a new UI1_3 or raises the existing
%      singleton*.
%
%      H = UI1_3 returns the handle to a new UI1_3 or the handle to
%      the existing singleton*.
%
%      UI1_3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UI1_3.M with the given input arguments.
%
%      UI1_3('Property','Value',...) creates a new UI1_3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ui1_3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ui1_3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ui1_3

% Last Modified by GUIDE v2.5 20-Mar-2015 18:57:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ui1_3_OpeningFcn, ...
                   'gui_OutputFcn',  @ui1_3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ui1_3 is made visible.
function ui1_3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ui1_3 (see VARARGIN)

% Choose default command line output for ui1_3
...
% so window can get raised using ui1_3.
...
% UIWAIT makes ui1_3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ui1_3_OutputFcn(hObject, eventdata, handles)
