function varargout = ui1_5(varargin)
% UI1_5 MATLAB code for ui1_5.fig
%      UI1_5, by itself, creates a new UI1_5 or raises the existing
%      singleton*.
%
%      H = UI1_5 returns the handle to a new UI1_5 or the handle to
%      the existing singleton*.
%
%      UI1_5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UI1_5.M with the given input arguments.
%
%      UI1_5('Property','Value',...) creates a new UI1_5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ui1_5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ui1_5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ui1_5

% Last Modified by GUIDE v2.5 20-Mar-2015 20:58:45

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ui1_5_OpeningFcn, ...
                   'gui_OutputFcn',  @ui1_5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ui1_5 is made visible.
function ui1_5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ui1_5 (see VARARGIN)

% Choose default command line output for ui1_5
...
% so window can get raised using ui1_5.
if strcmp(get(hObject,'Visible'),'off')
    
    set(handles.slider3,'Value',    1);%C1
    set(handles.slider4,'Value',    70);%C1
    set(handles.slider5,'Value',    1);%C1
    set(handles.slider6,'Value',    1);%C1
    set(handles.slider7,'Value',    1);%C1
    set(handles.slider8,'Value',    100);%C1
    set(handles.slider9,'Value',    -2);%C2
    set(handles.slider10,'Value',    0);%C3
    set(handles.slider11,'Value',    -1);%C4
    set(handles.slider12,'Value',    0);%C5
    set(handles.slider13,'Value',    -1);%C6
    set(handles.slider14,'Value',    0);%C7
    set(handles.slider15,'Value',    -1);%C8
    set(handles.slider16,'Value',    0);%C9
    set(handles.slider17,'Value',    0);%C10
    set(handles.slider18,'Value',    -1);%C11
    set(handles.slider19,'Value',    -1);%C12
    set(handles.slider20,'Value',    0);%C13
    set(handles.slider21,'Value',    0);%C14
    set(handles.slider22,'Value',    -1);%C15
    set(handles.slider23,'Value',    0);%C16
    set(handles.slider24,'Value',    -1);%C17
    set(handles.slider27,'Value',    -2);%
    set(handles.slider28,'Value',    log10(1.5));%
    set(handles.slider29,'Value',    0);%
    set(handles.slider30,'Value',    -3);%
    set(handles.slider31,'Value',    2);%
    set(handles.slider33,'Value',    0);%
    set(handles.slider34,'Value',    2);%
    
    %main;
    %plot(rand(5));
end

% UIWAIT makes ui1_5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ui1_5_OutputFcn(hObject, eventdata, handles)
...
% eventdata  reserved - to be defined in a future version of MATLAB
updateInfo(hObject,handles);% handles    structure with handles and user data (see GUIDATA)
